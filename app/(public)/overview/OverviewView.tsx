...
const OVERVIEW_I18N = {
  zh: {
    ...
    navMatrix: '📊 矩阵对比',
    launchApp: '进入工作台',
    heroBadge: '云端 · 客户端 · 整机 · 插件，同一个工作台',
    heroTitle: '先知道做什么，再谈怎么写',
    heroDesc: '给持续更新的创作者：每天早上一份带理由的选题推荐，覆盖抖音、小红书、公众号、B 站、视频号。这一页讲它有哪几种装法——云端直接用，Mac / Windows 客户端让数据自动回流，整机版把一切留在你自己的机器上。',
  ...
  en: {
    ...
    heroBadge: 'Cloud · Desktop · Appliance · Extension, one workspace',
    heroTitle: 'Know what to make before you write.',
    heroDesc: 'For creators who publish every week: a daily topic brief with reasons, across Douyin, Xiaohongshu, WeChat, Bilibili and Channels. This page is about the ways to run it: in the cloud, as a Mac / Windows app that syncs your data, or as an appliance that keeps everything on your own machine.',
    ...
    matrixRows: [
      ...
      ['Private Creator Back-Office Data Sync (Channels/Douyin/Xiaohongshu/Bilibili)', '—', '—', '—', '✓ Required'],
      ['WeChat Official Accounts & Channels Scraping', '—', '—', '—', '— Not available'],
