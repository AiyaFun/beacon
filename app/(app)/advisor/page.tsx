...
import { PageHead, Card, Meter, ScorePill, Empty } from '@/components/ui';
...
export default async function AdvisorPage() {
  ...
  return (
    <>
      <PageHead
        title="选题智囊团"
        desc={`${panelSize} 位人物混编会诊 · 受众侧模拟第一反应，专家侧做多维把关 · 身份可自定义，采纳/否决驱动人物成长`}
        action={<ConveneForm panelSize={panelSize} />}
      />
