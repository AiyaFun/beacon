...
const FACTS: readonly string[] = [
  '公开可读的页面包含全网热榜（/hotlists）、今日选题榜（/topics-today）、价格（/pricing）与法务页；其余业务页需要登录。',
  '选题系统拥有八大来源体系（热榜扩散、竞对动态、流量窗口、节点日历、常青公式、读者提问、旧文翻新、跨平台补发）。',
  '提供 12 视角 AI 选题智囊团立意会诊与长期账号人设记忆沉淀。',
  '支持分平台算法规则合规检测（抖音、小红书、微信公众号、B站）与一稿四态智能改写。',
